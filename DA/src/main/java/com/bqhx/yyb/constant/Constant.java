...
public final class Constant {
	 ...
	 * 导入用户模板_
	 */
	public static final String CODINGTEMPLATENAME = "导入用户模板_";
	/** 
	 * 付方账号
	 */ 
	 ...
	 * 人资模板中#{syb}
	 */
	public static final String SYBTEMP = "#{syb}";
	/**
	 * 人资模板中#{dq}
	 */
	public static final String DQTEMP = "#{dq}";
	/**
	 * 人资模板中#{moneySum}
	 */
	public static final String MONEYSUMTEMP = "#{moneySum}";
	/**
	 * salt
	 */
	public static final String SALT = "CXWcjvILHE1wI8YTEsLZpS0pWj59A36Kd";
}
